    ...
    return (
        <section id="Section1" style={{ position: 'relative', height: '100vh', overflow: 'hidden', backgroundColor: '#232323' }}>
            ...
            <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', color: '#fff', textAlign: 'center' }}>
                ...
                <h2 style={{fontSize:'30px', marginInline:'20px'}}>Skyline Eystates: Expert real estate guidance to find your dream property. Experience seamless buying, selling, and investing with personalized care and trust.</h2>
            </div>
        </section>
    );
};
